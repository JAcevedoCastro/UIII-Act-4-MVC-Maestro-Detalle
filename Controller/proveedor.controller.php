...
class ProveedorController{
    ...
    public function Guardar(){
        ...
        $pvd->nombre_empresa = $_REQUEST['nombre_empresa'];
        $pvd->nombre_empleado = $_REQUEST['nombre_empleado'];
        $pvd->telefono = $_REQUEST['telefono'];
        $pvd->ubicacion = $_REQUEST['ubicacion'];
        $pvd->nombre_empleado = $_REQUEST['nombre_empleado'];
        $pvd->calidad = $_REQUEST['calidad'];
        $pvd->nacion = $_REQUEST['nacion'];
        $pvd->transporte = $_REQUEST['transporte'];
